...
$("#usuarios").jqGrid({
        editurl: 'editUsuario/',  
	url:'getOficina',//funcion en el controller para datos json
	...
	colNames:['Nombre Completo','Usuario','Correo Electronico','Oficina','num_usuario','status','tipo_usuario',''],       //Grid column headings
		...
		{name:'nombre',index:'nombre', width:140, align:"left", sortable:false, title:false},
                {name:'nom_usuario',index:'nom_usuario', width:105, align:"left", sortable:false, title:false},
	...
	viewrecords: true,
	multiselect:true,
	caption:"USUARIOS DE OFICINA ACTIVOS",
